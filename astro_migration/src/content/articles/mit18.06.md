---
title: 'Mathematics'
description: '我们从求解线性方程组来开始这门课，从一个普通的例子讲起：方程组有 \(2\) 个未知数，一共有 \(2\) 个方程，分别来看方程组的“行图像”和“列图像”。'
pubDate: '2025-12-24'
category: 'Tech'
readTime: '5 Min Read'
heroImage: '/images/MIT18.06/row_picture.png'
---
...
![Row Picture](/images/MIT18.06/row_picture.png)
...
![Column Picture](/images/MIT18.06/column_picture.png)
