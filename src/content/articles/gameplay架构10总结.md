---
title: "GamePlay架构10：总结"
description: "GamePlay架构10：总结"
category: "Article"
date: "2026-02-04"
tags:
  - Article
...
1. AActor中一些需要逻辑控制的成员分化出了APawn
1. AController是用来控制APawn的一个特殊的AActor
1. 到了Level这一层，UE为我们提供了ALevelScriptActor（关卡蓝图）当作关卡静态性的逻辑载体
1. 而对于一场游戏或世界的规则，UE提供的AGameMode就只是一个虚拟的逻辑载体
1. World构建好了，该派玩家进来了
1. 所有的表示和逻辑汇集到一起，形成了全局唯一的UGameInstance对象，代表着整个游戏的开始和结束。同时为了方便开发者进行玩家存档，提供了USaveGame进行全局的数据配套
# **整体类图**
