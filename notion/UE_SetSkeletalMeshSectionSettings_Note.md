...
在 [UE 学习笔记：从 C++ 到 Python 的函数暴露机制](../UEPythonBinding/index.html) 一文中，我们探讨了 Unreal Engine 如何利用反射系统自动将 C++ 函数暴露给 Python。
...
**CRITICAL WARNING**: 在 UE5 中，仅仅修改 `LODModel.Sections` 是不够的！
