---
title: 'Groom Physics'
description: '启用模拟我们发现整个头发的模拟都是基于 Niagara 粒子来驱动的；但不需要担心，大多数情况下应用预设即可。'
pubDate: '2025-12-24'
category: 'Tech'
readTime: '5 Min Read'
heroImage: '/images/GroomParameters/Untitled.png'
---

![Solver Settings](/images/GroomParameters/Untitled.png)
...
![Solve Bend Demo](/images/GroomParameters/1.gif)

**投射弯曲 Project Bend**：顶点之间相关信息的约束解算

![Project Bend Demo](/images/GroomParameters/2.gif)
...
![Collision Radius Example 1](/images/GroomParameters/Untitled_1.png) ![Collision Radius Example 2](/images/GroomParameters/Untitled_2.png)
