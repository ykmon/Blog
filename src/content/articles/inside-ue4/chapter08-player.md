...
大部分游戏引擎，解决这个问题的思路就是不解决，要嘛是限制功能，要嘛就是美名其曰让开发者自己灵活控制。
...
<img loading="lazy" decoding="async" src="/Articles/InsideUE4/Chapter08-Player/image.png" alt="UPlayer 与 PlayerController 关系图">

***思考：为什么UPlayer不能继承自AActor***

因为AActor是绑定UWorld的世界实体且生命周期随关卡，而玩家对象需要跨世界/关卡持久化，同时玩家核心是逻辑数据而非实体，继承AActor会带来冗余特性并导致数据管理繁琐易丢失。
...
<img loading="lazy" decoding="async" src="/Articles/InsideUE4/Chapter08-Player/image 1.png" alt="ULocalPlayer 结构示意">

## UNetConnection

非常耐人寻味的是，在UE里，一个网络连接也是个Player。

<img loading="lazy" decoding="async" src="/Articles/InsideUE4/Chapter08-Player/image 2.png" alt="UNetConnection 作为 Player 的关系图">
